...
import SetValueReducer from "./set_value_reducer";

// Import all procedure arg schemas

// Import all table schema definitions
import SyncStateRow from "./sync_state_table";
...
const tablesSchema = __schema({
  sync_state: __table({
    name: 'sync_state',
    indexes: [
      { accessor: 'id', name: 'sync_state_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  __reducerSchema("set_value", SetValueReducer),
);
